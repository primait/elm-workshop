...
module Gql.Swapi.Object.FilmPlanetsConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.FilmPlanetsEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.FilmPlanetsConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.FilmPlanetsConnection
totalCount =
