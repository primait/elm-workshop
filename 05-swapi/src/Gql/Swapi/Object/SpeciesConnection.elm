...
module Gql.Swapi.Object.SpeciesConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.SpeciesEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.SpeciesConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.SpeciesConnection
totalCount =
