...
module Gql.Swapi.Object.VehiclesConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.VehiclesEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.VehiclesConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.VehiclesConnection
totalCount =
