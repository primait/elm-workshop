...
module Gql.Swapi.Object.PeopleConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.PeopleEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.PeopleConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.PeopleConnection
totalCount =
