...
module Gql.Swapi.Object.FilmSpeciesConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.FilmSpeciesEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.FilmSpeciesConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.FilmSpeciesConnection
totalCount =
