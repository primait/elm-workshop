...
module Gql.Swapi.Object.PlanetsConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.PlanetsEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.PlanetsConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.PlanetsConnection
totalCount =
