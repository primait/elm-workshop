...
module Gql.Swapi.Object.StarshipsConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.StarshipsEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.StarshipsConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.StarshipsConnection
totalCount =
