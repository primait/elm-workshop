...
module Gql.Swapi.Object.FilmsConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Gql.Swapi.Object.FilmsEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Gql.Swapi.Object.FilmsConnection
edges object_ =
...
for example.
-}
totalCount : SelectionSet (Maybe Int) Gql.Swapi.Object.FilmsConnection
totalCount =
